...
$data['view'] = ((isset($_GET['mannschaft_id']))?(VIEW_DETAIL):(VIEW_LIST));
...
{
	$Mannschaft = new CMannschaft($_GET['mannschaft_id']);
...
if(VIEW_LIST == $data['view'])
{
	...
	switch($data['sort'])
	{
		case 1: $query .= ' ORDER BY m.aklagruppe DESC, s.beginn DESC'; break;
		default: $query .= ' ORDER BY s.beginn DESC, m.aklagruppe DESC'; break;
	}
	//--------------------------------------------------------------------------------------------------------------------
	// Abfrage
	//--------------------------------------------------------------------------------------------------------------------
