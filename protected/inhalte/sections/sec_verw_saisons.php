...
werden, so würden abhängige Datensätze in anderen Tabellen automatisch mit gelöscht. Beispielsweise würden alle
...
if ($Saison->isDeletable()) {
    ...
    foreach ($GLOBALS['Enum']['Spielregel'] as $Spielregel) {
        echo '<option value="'.$Spielregel.'">'.C2S_Spielregel($Spielregel).'</option>'."\n";
    }
    echo '</select>'."\n";
} else {
